...
use App\Http\Requests\PhonebookRequest as StoreRequest;
use App\Http\Requests\PhonebookRequest as UpdateRequest;

class PhonebookCrudController extends CrudController
{
    private $profile;
    ...
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Phonebook');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/phonebook');
        $this->crud->setEntityNameStrings('Phone Number', 'Phone Numbers');
        ...
        */
        ...
        $this->crud->addFields([
            ...
            [
                'name' => 'area_code',
                'label' => 'Area / Province / State / Region Code',
                'wrapperAttributes' => [
                    'class' => 'form-group col-md-3'
                ]
            ],
